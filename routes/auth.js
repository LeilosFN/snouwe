...
app.post("/account/api/oauth/token", async (req, res) => {
    ...
    try {
        ...
        return error.createError(
            "errors.com.leilos.tf.common.oauth.invalid_client",
    ...
    switch (req.body.grant_type) {
        ...
        case "password":
            if (!req.body.username || !req.body.password) return error.createError(
                "errors.com.leilos.tf.common.oauth.invalid_request",
            ...
            let err = () => error.createError(
                "errors.com.leilos.tf.account.invalid_account_credentials",
        ...
        case "refresh_token":
            ...
            try {
                ...
                error.createError(
                    "errors.com.leilos.tf.account.auth_token.invalid_refresh_token",
        ...
        case "exchange_code":
            ...
            if (index == -1) return error.createError(
                "errors.com.leilos.tf.account.oauth.exchange_code_not_found",
        ...
        default:
            error.createError(
                "errors.com.leilos.tf.common.oauth.unsupported_grant_type",
    ...
    if (req.user.banned) return error.createError(
        "errors.com.leilos.tf.account.account_not_active",
